...
st.set_page_config(page_title="Python CS_384 Project_3",page_icon=":four_leaf_clover:",layout="wide")     
new_title = '<p style="font-family:roboto; color:red; font-size: 50px;text-align:center ">Python Project 3</p>'
st.markdown(new_title, unsafe_allow_html=True)
var_1=st.number_input('Constant_fk2d',value=0.75)  #constant_fk2d=0.75 
var_2=st.number_input('Multiplying_factor_3d',value=0.5)              # multiplying_factor_3d=0.5 
var_3=st.text_input('Shear_velocity',value='2.6**3')    #Shear_velocity=2.6**3
if var_1 :
    if var_2:
        if var_3:
            ...
            ['NONE','1. C','2. S','3. A','4. C & S','5. C & A','6. S & A','7. C & S & A','8. all combine']
    )
        
            if cch == '1. C':
                ch = 1
                corr = st.number_input('Enter thresold value C:',value=15,step=1)
            elif cch == '2. S':
                ch = 2
                SNR = st.number_input('Enter thresold value S:',value=15,step=1)
            elif cch == '3. A':
                ch = 3
                Lambda = st.number_input('Enter Lambda value for A:',value=15,step=1)
                k = st.number_input('Enter k value for A:',value=15,step=1)
            ...
            aa=st.selectbox(
            "Chose Replacement Method From below:",
            ['NONE','1. previous point','2. 2*last-2nd_last','3. overall_mean',
            '4. 12_point_strategy','5. mean of previous 2 point',
            '6. all seqential','7. all parallel'])
            if aa == '1. previous point':
                a = 1
            elif aa == '2. 2*last-2nd_last':
                a = 2
            elif aa == '3. overall_mean':
                a = 3
            elif aa == '4. 12_point_strategy':
                a = 4
            elif aa == '5. mean of previous 2 point':
                a = 5
            elif aa == '6. all seqential':
                a = 6
            elif aa == '7. all parallel':
                a = 7
